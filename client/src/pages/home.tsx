    ...
    <Layout>
      ...
      <section className="py-20 bg-gray-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-neutral-dark mb-4">Our Trusted Clients</h2>
            <p className="text-lg text-neutral-gray">Partnering with industry leaders worldwide</p>
          </div>
            ...
            <div className="flex space-x-16 animate-marquee">
              ...
              <div className="flex items-center justify-center min-w-[200px] h-24 bg-white rounded-lg shadow-sm px-8">
                <div className="text-center">
                  <div className="text-2xl font-bold text-gray-600 mb-1">TECH</div>
                  <div className="text-xs text-gray-400 uppercase tracking-wider">Solutions</div>
                </div>
              </div>
              
              <div className="flex items-center justify-center min-w-[200px] h-24 bg-white rounded-lg shadow-sm px-8">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600 mb-1">● WATER</div>
                  <div className="text-xs text-gray-400 uppercase tracking-wider">Works</div>
                </div>
              </div>
              
              <div className="flex items-center justify-center min-w-[200px] h-24 bg-white rounded-lg shadow-sm px-8">
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600 mb-1">≡ INFRASTRUCTURE</div>
                  <div className="text-xs text-gray-400 uppercase tracking-wider">Group</div>
                </div>
              </div>
              
              <div className="flex items-center justify-center min-w-[200px] h-24 bg-white rounded-lg shadow-sm px-8">
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600 mb-1">⬛ MANUFACTURING</div>
                  <div className="text-xs text-gray-400 uppercase tracking-wider">Corp</div>
                </div>
              </div>
              
              <div className="flex items-center justify-center min-w-[200px] h-24 bg-white rounded-lg shadow-sm px-8">
                <div className="text-center">
                  <div className="text-2xl font-bold text-yellow-600 mb-1">▲ ENERGY</div>
                  <div className="text-xs text-gray-400 uppercase tracking-wider">Solutions</div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center min-w-[200px] h-24 bg-white rounded-lg shadow-sm px-8">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600 mb-1">— PIPELINE</div>
